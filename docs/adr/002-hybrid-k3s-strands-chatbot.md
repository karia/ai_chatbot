...
Discord Gatewayの常駐WebSocket接続には既存k3sの容量を利用し、ECS等の常駐環境を新設する費用と比較する。
...
| AWS中心案 | Slack | 18.01 |
| ハイブリッド案 | Slack | 15.33 |
| AWS中心案と常駐Gateway | SlackとDiscord | 33.11 |
...
詳細は[AWS中心案の月額試算](001-serverless-strands-chatbot.md#discord-gatewayをawsで常駐させる場合)を参照する。
